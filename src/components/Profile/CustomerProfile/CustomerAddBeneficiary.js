...
export const AddNewBeneficiary = () => {
    ...
    return (
        <div className="add-beneficiary-container">
            <form className="add-beneficiary-form">
                <h2 className="add-beneficiary-title">Add New Beneficiary</h2>

                <fieldset>
                    <div className="add-beneficiary-form-group">
                        ...
                        <input
                            ...
                            onChange={(evt) =>
                                updateBeneficiary({ ...beneficiary, name: evt.target.value })
                            }
                        />
                    </div>
                </fieldset>
                ...
                <fieldset>
                    <div className="add-beneficiary-form-group">
                        ...
                        <input
                            ...
                            onChange={(evt) =>
                                updateBeneficiary({ ...beneficiary, address: evt.target.value })
                            }
                        />
                    </div>
                </fieldset>
                ...
                <fieldset>
                    <div className="add-beneficiary-form-group">
                        ...
                        <input
                            ...
                            onChange={(evt) =>
                                updateBeneficiary({ ...beneficiary, phoneNumber: evt.target.value })
                            }
                        />
                    </div>
                </fieldset>
                ...
                <fieldset>
                    <div className="add-beneficiary-form-group">
                        ...
                        <input
                            ...
                            onChange={(evt) =>
                                updateBeneficiary({ ...beneficiary, dateOfBirth: evt.target.value })
                            }
                        />
                    </div>
                </fieldset>
                ...
                <fieldset>
                    <div className="add-beneficiary-form-group">
                        ...
                        <input
                            ...
                            onChange={(evt) =>
                                updateBeneficiary({ ...beneficiary, relationship: evt.target.value })
                            }
                        />
                    </div>
                </fieldset>
                ...
                <fieldset>
                    <div className="add-beneficiary-form-group">
                        ...
                        <select
                            ...
                            onChange={(evt) =>
                                updateBeneficiary({ ...beneficiary, typeId: parseFloat(evt.target.value) })
                            }
                        >
                            <option value="">Select a Beneficiary Type</option>
                            {!primaryBeneficiary && <option value="1">Primary</option>}
                            {!secondaryBeneficiary && <option value="2">Secondary</option>}
                        </select>
                    </div>
                </fieldset>

                {!primaryBeneficiary && (
                    <button onClick={handleInitialSaveButtonClick} className="add-beneficiary-button">
                        Submit Primary Beneficiary Info
                    </button>
                )}

                {!secondaryBeneficiary && (
                    <button onClick={handleSecondarySaveButtonClick} className="add-beneficiary-button">
